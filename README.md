...
**The 27.4 GB dataset is not in this repository.** It lives on a Modal volume and is regenerated by
the Stage 1 commands above (deterministic given the seeds in `recipe.yaml`).
...
- Dataset: [maxmill/aq-mario-smb1](https://huggingface.co/datasets/maxmill/aq-mario-smb1)
- Model: [maxmill/aq-mario](https://huggingface.co/maxmill/aq-mario)
